...
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (1, 'Buty robocze', 'ShoeMann', 'Czarne buty robocze dobrej jakości.', 'TOOLS_AND_ARTICLES', 12, 74.99, 99.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (2, 'Widły', 'Toolers', 'Narzędzie idealne do tępienia heretyków, którzy twierdzą, że Maszyna W jest niepotrzebna i nieaktualna.', 'TOOLS_AND_ARTICLES', 1, 37.50, 49.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (3, 'Taśma malarska', 'la Coleur', 'Papierowa taśma malarska przeznaczona do zabezpieczania powierzchni podczas malowania. Przydatna również przy klejeniu lekkich kartonów. Szerokość: 38 mm  Długość: 25 m  Kolor: żółty', 'TOOLS_AND_ARTICLES', 120, 2.99, 3.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (4, 'Pazurki ogrodoowe', 'Toolers', 'Narzędzie, dzięki któremu plewienie będzie samą przyjemnością.', 'TOOLS_AND_ARTICLES', 19, 22.49, 29.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (5, 'Kilof', 'Heavy metal', 'Narzędzie idealne do przekuwania wiedzy teoretycznej w projekty studenckie.', 'TOOLS_AND_ARTICLES', 9, 49.99, 54.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (6, 'Antena', 'Signal', 'Działa w dwóch polaryzacjach. Nowy model najmocniejszej anteny dostępnej na rynku. Dopracowana konstrukcja i ulepszone podzespoły. W pełni odporna na warunki atmosferyczne. Wzmocniona konstrukcja. Dodatkowy dipol. Odbiera Full HD TV oraz MUX 8. Złącze antenowe "F" (standardowe). WBUILDINGny filtr przeciw zakłóceniom LTE. Zasięg Fabryczny Anteny  80km, zysk energetyczny: 32dB, długość anteny: 78cm. ', 'INSTALLATION', 221, 82.38, 99.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
...
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (8, 'Grzejnik żeliwny', 'Heatex', 'Powrót do przeszłości. Wykonawstwo, styl, efektywność to tylko niektóre cechy charakteryzujące grzejniki żeliwne. Ten rodzaj grzejników sprawdza się w ogrzewaniu miejskim, na paliwo stałe oraz do instalacji gazowych. Poprzez swoją bezwładność oraz duży zład wody są bezkonkurencyjne na obecnym rynku porównując to do innych grzejników. Nasze grzejniki przeszły gruntowną renowację. Wypiaskowane, poddane próbie szczelności, malowane farbami podkładowymi oraz farbami renowacyjnymi. Wymiary:Wysokość 60 cm. Szerokość 42 cm. Głębokość 14 cm. Rozstaw przyłączy: 50 cm. Moc: 600 W. Kolor: biały. Istnieje możliwość aranżacji grzejnika w dowolnym kolorze.', 'INSTALLATION', 14, 700.0, 800.0);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (9, 'Zewnętrzny czujnik ruchu', 'SENSitive', 'Mikroprocesorowa analiza sygnału podczerwieni. Dwa dualne PIR - elementy i dwie soczewki Fresnela. Automatyczna regulacja czułości. Automatyczne "inteligentne" dostosowanie parametrów do zmian warunków otoczenia. Automatyczna podwójna kompensacja temperatury.', 'INSTALLATION', 21, 75.50, 89.90);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (10, 'Czujnik dymu', 'SENSitive', 'Niezwykle dokładny i prosty do zamontowania czujnik fotoelektryczny, który poprawi bezpieczeństwo nasze oraz osób w naszym otoczeniu.Wysokiej jakości urządzenie, dzięki któremu możemy monitorować zamknięte pomieszczenia pod kątem obecności dymu lub wykrycia pożaru. Dzięki jego niewielkim rozmiarom, możemy zamocować go w dowolnym miejscu, bez zbędnego okablowania. Wczesne wykrycie dymu i ognia. Wytrzymała, 10-letnia bateria litowa. Zgodny z normą europejską EN14604:2005. Skuteczny alarm dźwiękowy (85 dB/3m). Migający wskaźnik LED, informujący o niebezpieczeństwie. Łatwy w montażu (na dowolnej ścianie lub suficie). Wyłączanie alarmu za pomocą jednego przycisku. Kompaktowa i solidna oBUILDING. Obszar detekcji 20-40 m2. Czułość wykrywania dymu: 0,120-0,155 db/m. yłoszczelny i ognioodporny materiał (ABS). ', 'INSTALLATION', 212, 55.20, 65.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (11, 'Begonia', 'GARDEN Heaven', 'Begonia to rodzaj roślin z rodziny begoniowatych obejmujący według różnych autorów 1200–1500 gatunków. Występują na wszystkich, z wyjątkiem Australii obszarach tropikalnych i subtropikalnych kuli ziemskiej, najliczniejsza grupa gatunków występuje w Ameryce Południowej.', 'GARDEN', 10, 14.99, 17.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (12, 'Oświetlenie ogrodowe', 'Light Up The Night', 'Zjawiskowe lampki wprowadzające niepowtarzalną atmosferę podczas wieczornych imprez w GARDENzie. Zasilane są energią elektryczną. Długość łańcucha z lampkami: 5m.', 'GARDEN', 9, 59.99, 79.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (13, 'Konewka', 'Toolers', 'Żółta, designerska konewka, która nie tylko ułatwi podlewanie kwiatów, ale także będzie pełniła rolę dekoracyjną.', 'GARDEN', 9, 19.99, 24.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (14, 'Huśtawka', 'GARDEN Heaven', 'Huśtawka jednoosobowa. Maksymalny udźwig: 150kg.', 'GARDEN', 8, 219.99, 280.0);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (15, 'Plac zabaw', 'GARDEN Heaven', 'Plac zabaw, który przysporzy wiele radości rodzicom, którzy przez kilka godzin będą składali konstrukcję oraz dzieciom, które spędzą na nim łącznie godzinę. W skład placu zabaw wchodzą zjeżdżalnia z drabinkami oraz trzy huśtawki.', 'GARDEN', 71, 2500.0, 3500.0);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (16, 'Betoniarka', 'Robert De Builder', 'Zasilanie: 230V, 50Hz. Moc silnika: 220 W. Pojemność całkowita: 63 litrów. Średnica otworu: 260 mm. Obroty: 27,5 obr/min. Wymiary zewnętrzne: 116 x 550 x 935 mm. Waga: 26 kg. ', 'BUILDING', 23, 749.99, 849.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (17, 'Cegła rozbiórkowa', 'Robert De Builder', '', 'BUILDING', 42, 0.38, 0.5);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (18, 'Okno PCV plastikowe', 'Knock Knock', 'Okno plastikowe PCV dostępne w kolorach białym i brązowym. Wymiary do uzgodnienia.', 'BUILDING', 24, 735.0, 980.0);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (19, 'Rynna PVC', 'Robert De Builder', 'Średnica: 125mm. Materiał: Tworzywo sztuczne. Gwarancja:10 Lat. WAŻNE: Dostępne są różne kolory, więc podczas zakupu proszę podać kolor.', 'BUILDING', 19, 14.99, 19.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (20, 'Drabina aluminiowa', 'Robert De Builder', 'Drabina aluminiowa domowa. Materiał: Aluminium. Rodzaj Łączenia Szczebli: Nitowanie. Wysokość Do Podestu: 0,54m. Liczba Stopni/Szczebli: 4. Maksymalne Obciążenie: 130 kg. Wysokość Robocza: 2,75 m. Wysokość Do Podestu: 0,75 m. Szerokość Drabiny: 0,43 m. Długość Drabiny Złożonej: 1,45 m. Grubość Drabiny Złożonej : 0,115 m. Waga: 2,9 kg. Wejście: Jednostronne', 'BUILDING', 65, 74.99, 99.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (21, 'Karnisz metalowy', 'Heavy metal', 'Piękny, metalowy karnisz z jeszcze piękniejszym zdobieniem na końcach. Cena za 1m.', 'ARRANGEMENT', 28, 82.49, 110.0);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (22, 'Wanna wolnostojąca', 'arrrrMATURA', 'Biała, wolnostojąca wanna, idealna do nowoczesnych wnętrz. Długość: 1,6m. Szerokość: 1m. ', 'ARRANGEMENT', 82, 2999.99, 3999.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (23, 'Płytki podłogowe', 'FloorAndWalls', 'Sześciokąt foremny to w naturze kształt idealny, dlatego my stworzyliśmy dla Ciebie płytki idealne: trwałe, lśniące, łatwe w czyszczeniu, sześciokątne płytki podłogowe. Są niezwykle efektowne. Łatwo je utrzymać w stanie takim jak nowe. Cena za 1m2.', 'ARRANGEMENT', 99, 44.99, 69.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (24, 'Lampa stołowa', 'Light Up The Night', 'Piękna lampka stolikowa idealnie nadająca się do nowoczesnych wnętrz.', 'ARRANGEMENT', 120, 244.49, 325.99);
INSERT INTO products(id, name, producer, description, category, number_of_items_in_stock, purchase_price, retail_price) VALUES
    (25, 'Lustro dekoracyjne postarzane', 'Workucci', ' Lustro dekoracyjne postarzane. W prawdzie nie przejrzysz się w nim, ale może to dobrze, przynajmniej nie zobaczysz swoich worków pod oczami. Wymiary: 1x2m', 'ARRANGEMENT', 1, 440.0, 330.0);

INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (1, 74.99, '2012-12-12', 100, 1);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (2, 37.50, '2012-12-12', 300, 2);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (3, 2.99, '2012-12-12', 231, 3);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (4, 22.49, '2013-10-11', 10, 4);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (5, 49.99, '2014-11-10', 1, 5);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (6, 82.38, '2015-10-09', 11, 6);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (7, 750.0, '2020-09-21', 72, 7);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (8, 700.0, '2019-02-23', 999, 8);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (9, 75.50, '2022-05-31', 43, 9);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (10, 55.20, '2021-08-14', 34, 10);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (11, 14.99, '2013-07-19', 52, 11);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (12, 59.99, '2014-06-02', 8, 12);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (13, 19.99, '2015-12-12', 113, 13);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (14, 219.99, '2017-11-11', 7, 14);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (15, 2500.0, '2018-12-22', 5, 15);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (16, 749.99, '2019-01-23', 3, 16);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (17, 0.38, '2020-02-08', 10, 17);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (18, 735.0, '2021-07-04', 12, 18);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (19, 14.99, '2022-05-02', 10, 19);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (20, 74.99, '2013-12-01', 9, 20);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (21, 82.49, '2012-09-17', 89, 21);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (22, 2999.99, '2013-12-18', 72, 22);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (23, 44.99, '2014-11-20', 13, 23);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (24, 244.49, '2019-10-21', 31, 24);
INSERT INTO product_restock(id, purchase_price, restock_date, quantity, product_id) VALUES (25, 440.0, '2020-01-02', 100, 25);
...
INSERT INTO orders(id, order_date, payment_method, user_id) VALUES (6, '2022-06-06', 'CASH', 7);
